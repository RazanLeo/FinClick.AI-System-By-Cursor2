...
export class MasterAnalyzer extends BaseAnalyzer {
  async analyze(financialData: FinancialStatement[], companyData: Company, marketData?: any, benchmarkData?: any): Promise<AnalysisResult[]> {
    ...
    try {
      ...
      return [this.createErrorResult('master-error', 'خطأ في التحليل الشامل')];
    }
  }
  ...
  private calculateComprehensiveProfitabilityAnalysis(statement: FinancialStatement, benchmarkData?: any): AnalysisResult {
    ...
    return {
      ...
      calculation: {
        formula: '(هامش صافي الربح ÷ 2) + (الهامش التشغيلي ÷ 2) + (الهامش الإجمالي ÷ 4) + (العائد على الأصول × 2) + (العائد على حقوق الملكية ÷ 2) + (العائد على رأس المال المستثمر × 2) + (هامش EBITDA ÷ 2)',
        variables: {
  ...
  private calculateComprehensiveLiquidityAnalysis(statement: FinancialStatement, benchmarkData?: any): AnalysisResult {
    ...
    return {
      ...
      calculation: {
        formula: '(النسبة الجارية × 20) + (النسبة السريعة × 20) + (نسبة النقد × 20) + (تغطية التدفق النقدي × 20) + (نسبة السيولة المطلقة × 20) + (نسبة رأس المال العامل × 20)',
        variables: {
  ...
  private calculateComprehensiveLeverageAnalysis(statement: FinancialStatement, benchmarkData?: any): AnalysisResult {
    ...
    return {
      ...
      calculation: {
        formula: '((100 - نسبة الدين إلى الأصول) ÷ 2) + ((1 ÷ (1 + نسبة الدين إلى حقوق الملكية)) × 50) + (نسبة حقوق الملكية إلى الأصول ÷ 2) + (تغطية الفوائد × 50) + (تغطية خدمة الدين × 50) + (الرفع المالي × 50)',
        variables: {
  ...
  private calculateComprehensiveEfficiencyAnalysis(statement: FinancialStatement, benchmarkData?: any): AnalysisResult {
    ...
    return {
      ...
      calculation: {
        formula: '(دوران الأصول الإجمالية × 30) + (دوران الأصول الثابتة × 20) + (دوران المخزون × 25) + (دوران الذمم المدينة × 25) + (دوران الذمم الدائنة × 25) + (دوران رأس المال العامل × 25)',
        variables: {
  ...
  private calculateComprehensiveGrowthAnalysis(financialData: FinancialStatement[], benchmarkData?: any): AnalysisResult {
    ...
    return {
      ...
      calculation: {
        formula: '(نمو الإيرادات ÷ 2) + (نمو الأرباح ÷ 2) + (نمو الأصول ÷ 2) + (نمو حقوق الملكية ÷ 2) + (استقرار النمو × 100) + (استدامة النمو × 100)',
        variables: {
